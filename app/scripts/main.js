...
angular.module('app').controller('AppCtrl', ['$scope', '$timeout', 'Serial', 'Logger',
    function($scope, $timeout, Serial, Logger) {
        ...
        //
        //
        // $scope.onWegant = function(port){
        //
        //     var frame = '\x01\x09\x36\x03\x1A\x00\x01';
        //     //var frame = '\x01\x03\x8E\x7C\x4F\x03\xFF';
        //     var crc = 0;
        //     for(var i=0; i<frame.length; i++){
        //         crc = CRC16(crc, frame.charCodeAt(i));
        //     }
        //     var crch = (crc >> 8);
        //     var crcl = crc & 255;
        //     frame += String.fromCharCode(crch, crcl);
        //     //port.connection.send('\x01\x09\x36\x03\x1A\x00\x01\xA9\xCE');
        //     //port.connection.send('\x01\x09\x36\x03\x1A\x00\x01\x34\xB7');
        //     var codes = [];
        //     for(var i=0; i<frame.length; i++){
        //         //crc = CRC16(crc, );
        //         codes.push(frame.charCodeAt(i));
        //     }
        //     console.log('Wegant', crc, crch, crcl, frame, codes);
        //
        //     /*var frame = '\x01\x09\x36\x03\x1A\x00\x01\x3E\xB7';
        //     port.connection.send(frame);*/
        //
        // };
        //
